...
def get_training_config(model):
    ...
    for i in model_hyperparameter_config:
        ...
        # in case of we need to change back to this
        #     {"uid":f"Hyperparameter0",
        #     "hyperparameter_configuration": hyperparameters_configuration_list}
...
if __name__ == '__main__':
    ...
    model_path = '/Users/pnc12/Library/CloudStorage/OneDrive-Personal/Work/NIST/MLLOS/Code/to_json_prod_1/mnist2ver3.keras'
    schema_path = '/Users/pnc12/Library/CloudStorage/OneDrive-Personal/Work/NIST/MLLOS/Code/to_json_prod_1/ml6.json'
