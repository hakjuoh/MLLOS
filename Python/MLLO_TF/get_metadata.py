...
def get_layers(model):
    ...
    return {"layer_index": layer_index_dict, 'input_layers': input_layers, 'nn_layers': nn_layers,
        ...
        if initializers_results[initializer]['AllIdentical'] == True:
            ...
            for initializer_config in initializers_results[initializer]['Data']['config']:
                ...
                configuration_setting_dict = {
                    ...
                    "configuration_setting_value_type": get_config_value_type(
                        initializers_results[initializer]['Data']['config'][initializer_config]),
                    "configuration_setting_value": initializers_results[initializer]['Data']['config'][
                        initializer_config]
                }
                        ...
                        for j in model_layers[i].get_config()[k]["config"]:
                            ...
                            configuration_setting_dict = {
                                "configuration_setting": {
                                    ...
                                    "configuration_setting_value_type": get_config_value_type(
                                        model_layers[i].get_config()[k]["config"][j]),
...
class KerasTensorFlowMetadataLoader(object):
    ...
    @property
    def framework(self):
        return 'KerasTensorFlow'

    def load_meta_data(self, model_path, *inputs):
        model, framework_version = load_model(model_path)
        ...
        return {
            ...
            "model_framework": {
                "uid": f"{to_pascal_case(self.framework)}{date_now}",
                "framework_type": self.framework,
